...
- [Mapped Types](../level_09/mapped_types.md) — Using literal keys to rebuild object definitions.
- [keyof Operator](../level_09/keyof.md) — Extracting keys to feed into template transformations.
