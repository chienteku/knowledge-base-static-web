...
## 1. Prerequisites
- [Generics Overview](../level_07/generics.md) — The core concept.
...
## 7. Related Terms
- [Type Aliases](../level_05/type_aliases.md) — Can also be Generic (`type MyType<T> = ...`).
- [Classes](../level_10/classes.md) — The OOP structures being made generic.
