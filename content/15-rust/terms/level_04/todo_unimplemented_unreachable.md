...
- [`panic!`](panic.md) — The mechanism all three of these macros are built on.
...
- [`panic!`](panic.md) — The underlying mechanism all three macros are thin, intent-communicating wrappers around.
