...
### Exercise 4: force-dynamic Segment Config
...
### Exercise 5: SSR vs CSR Security Advantage
...
### Exercise 6: force-dynamic Segment Config
...
### Exercise 7: SSR vs CSR Security Advantage
...
## 7. Related Terms
- [Static Site Generation (SSG)](../level_08/ssg.md) — The faster, build-time alternative to SSR.
- [Data Caching](../level_05/data_caching.md) — The `no-store` cache option directly triggers SSR.
