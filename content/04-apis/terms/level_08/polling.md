...
- [Server-Sent Events (SSE)](../level_08/sse.md) — The modern replacement for these hacks.
...
## 7. Related Terms
- [WebSockets](../level_08/websockets.md) — The technology that made Polling obsolete.
