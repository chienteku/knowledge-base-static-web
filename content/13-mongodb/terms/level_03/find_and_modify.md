...
### Mistake 4: Expecting `findOneAndUpdate()` to Return the Updated Document State by Default
...
### Mistake 5: Using `updateOne()` Followed by `findOne()` Instead of Atomic `findOneAndUpdate()`
...
### Exercise 1: Queue Pop Construction
...
### Exercise 2: Atomic Sequence Generator with `findOneAndUpdate`
