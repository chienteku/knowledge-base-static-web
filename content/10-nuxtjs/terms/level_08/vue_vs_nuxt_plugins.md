...
## 1. Prerequisites
- [`plugins/` Directory](../level_08/plugins_directory.md) — The folder where both types of plugins are initialized.
...
## 7. Related Terms
- [`plugins/` Directory](../level_08/plugins_directory.md) — The folder where these files must be placed.
