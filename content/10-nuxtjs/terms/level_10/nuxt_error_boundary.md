...
## 1. Prerequisites
- [`error.vue` Layout](../level_10/error_vue.md) — The global fatal error handler that `<NuxtErrorBoundary>` explicitly tries to avoid.
...
## 7. Related Terms
- [`error.vue`](../level_10/error_vue.md) — The global equivalent that handles fatal, unrecoverable errors.
