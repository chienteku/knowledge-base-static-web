...
- [`useState` Hook](../level_04/use_state.md) — The global state container whose data is transferred via this payload.
...
- [`useState` Hook](../level_04/use_state.md) — The state mechanism serialized inside the payload.
