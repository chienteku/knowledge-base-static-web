...
### Exercise 1: Component Auto-naming
...
### Exercise 2: Component Naming Resolution Matrix

**Problem:** Resolve the auto-imported Vue component tag name for the following component file paths:
1. `components/AppHeader.vue` 
2. `components/base/Card.vue` 
...
> 
> ```text
> Folder paths concatenate into PascalCase component tags.
> ```

---

### Exercise 3: Global Component Registration Suffix
