...
## 7. Related Terms
- [React DevTools](../level_08/react_devtools.md) — The parent browser utility containing the Profiler interface.
- [React.memo](../level_08/react_memo.md) — The caching HOC verified using the Profiler.
