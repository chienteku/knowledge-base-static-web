...
- [JSON](../level_07/json.md) — Text format used for data exchange and serialization.
...
## 7. Related Terms
- [JSON](../level_07/json.md) — The JavaScript Object Notation parser used for encoding/decoding objects to strings.
