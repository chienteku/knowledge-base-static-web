...
## 7. Related Terms
- [Mutating vs Non-mutating Methods](../level_04/mutating_vs_non_mutating.md) — The distinction between changing arrays in-place or returning new ones.
- [`slice` / `splice`](../level_04/slice_splice.md) — Index-based sub-array slicing and splicing.
