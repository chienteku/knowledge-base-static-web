...
## 7. Related Terms
- [Function](../level_03/function.md) — The block of code that the `return` statement exits.
- [Arrow Function](../level_03/arrow_function.md) — Has a feature called "implicit return" where the `return` keyword can be omitted.
