...
- [`calc()` Function](../../level_07/calc.md) — Evaluating runtime mathematical equations.
...
### Exercise 4: Fluid Typography with clamp()
...
### Exercise 5: Responsive Padding using min()
...
### Exercise 6: Fluid Typography with clamp()
...
### Exercise 7: Responsive Padding using min()
...
- [`calc()` Function](../../level_07/calc.md) — Basic CSS math.
