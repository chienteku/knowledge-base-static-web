...
## 1. Prerequisites
- [The Box Model](../level_02/box_model.md) — Normal properties like `margin` push other boxes around. `transform` ignores them!
...
### Exercise 4: Perfect 2D Center with Transform
...
### Exercise 5: Hardware Accelerated GPU Layer Trigger
...
### Exercise 6: Perfect 2D Center with Transform
...
### Exercise 7: Hardware Accelerated GPU Layer Trigger
