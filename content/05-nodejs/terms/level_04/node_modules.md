...
## 1. Prerequisites
- [NPM](../level_04/npm.md) — The tool that creates this folder.
- [package.json](../level_04/package_json.md) — The blueprint that tells NPM what to put inside this folder.
