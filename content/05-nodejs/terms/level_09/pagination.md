...
## 1. Prerequisites
- [REST APIs](../level_09/rest_api.md) — This is a standard requirement for all production GET requests.
...
### Exercise 4: Calculating SQL OFFSET for Page Number
...
### Exercise 5: Cursor-Based vs Offset Pagination Tradeoff
...
### Exercise 6: Calculating SQL OFFSET for Page Number
...
### Exercise 7: Cursor-Based vs Offset Pagination Tradeoff
...
- [The Request Object (`req`)](../level_07/req_res.md) — You extract the page numbers from `req.query`.
